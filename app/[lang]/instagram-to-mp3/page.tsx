...
export async function generateMetadata({
  ...
  return {
    title: dict.instagramToMP3.title,
    description: dict.instagramToMP3.description,
    alternates: generateHreflang(lang, "instagram-to-mp3"),
  };
}
...
export default async function InstagramToMP3Page({
  params: { lang },
}: {
  params: { lang: string };
}) {
  ...
  const ftdescription =
    dict.instagramToMP3.ftdescription;
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl font-bold mb-10">
              {dict.instagramToMP3.heroTitle}
            </h1>
            <p className="text-0.5xl text-gray-600 mb-1">
              {dict.instagramToMP3.heroText}
            </p>
          </div>
        </div>
      </section>
      ...
      <FeaturedTools featuredTools={insMP3Sites} description={ftdescription} dict={dict} />

      {/* Main Content Container */}
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto">
          {/* Our Services Section */}
          <FourCategories excludeWords="Instagram to MP3" currentLang={lang} />
